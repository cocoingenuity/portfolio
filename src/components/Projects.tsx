        ...
        <article className="project-card" data-reveal style={{ '--reveal-i': 1 } as CSSProperties}>
          <div className="project-card__body">
            ...
            <p className="project-card__desc">
              ...
              employers. It auto-detects each company's ATS and falls back to
              LLM extraction for custom sites, with cross-source dedup and 0 to
              100 resume match scoring. I built it for my own job search and
              use it every day.
            </p>
